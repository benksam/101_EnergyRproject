...
comp <- imputePCA(Educ[,2:58], ncp=4, scale=TRUE) ## Complète le tableau -c(121,206)

# compX <- imputePCA(Educ[,20:38], ncp=2, scale=TRUE) ## Complète le tableau -c(121,206)
...
comp <- imputePCA(Unemp[,1:18], ncp=4, scale=TRUE) ## Complète le tableau -c(121,206)

# compX <- imputePCA(Unemp[,20:38], ncp=2, scale=TRUE) ## Complète le tableau -c(121,206)
...
comp <- imputePCA(Prof, ncp=4, scale=TRUE) ## Complète le tableau -c(121,206)

# compX <- imputePCA(Prof[,20:38], ncp=2, scale=TRUE) ## Complète le tableau -c(121,206)
